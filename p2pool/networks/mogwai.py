from p2pool.mogwai import networks

# randall: todo change here a lot ...
...
PERSIST = True
WORKER_PORT = 7903
BOOTSTRAP_ADDRS = 'p2pool.mogwaicoin.info p2pool.mogwaicoin.org'.split(' ')
ANNOUNCE_CHANNEL = '#p2pool-mogwai'
