...
from p2pool.mogwai import data as mogwai_data, getwork
...
class StratumRPCMiningProvider(object):
    ...
    def _send_work(self):
        ...
        self.other.svc_mining.rpc_set_difficulty(mogwai_data.target_to_difficulty(x['share_target'])).addErrback(lambda err: None)
    ...
    def rpc_submit(self, worker_name, job_id, extranonce2, ntime, nonce):
        ...
        header = dict(
            ...
            merkle_root=mogwai_data.check_merkle_link(mogwai_data.hash256(new_packed_gentx), x['merkle_link']),
